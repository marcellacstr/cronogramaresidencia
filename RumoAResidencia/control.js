...
function addTarefa(){
	...
	let dominioInput = selectDominio.value;

	let textoDominioInput = selectDominio.options[selectDominio.selectedIndex].text;
	
	console.log(dominioInput);
	console.log(textoDominioInput);
